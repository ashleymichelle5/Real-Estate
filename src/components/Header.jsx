  ...
  return (
    <div className='min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden' style={{backgroundImage: "url('/header_img.png')" }} id='Header'>
      ...
      className='container text-center mx-auto py-4 px-6 md:px-20 lg:px-32 text-white'>
        ...
        <a href="#Contact" className='bg-blue-500 hover:bg-blue-600 px-4 sm:px-8 py-4 rounded-lg text-white font-semibold transition-all duration-300 text-sm sm:text-base block mx-auto text-center mt-8 w-fit'>
          <span className='hidden sm:inline'>SCHEDULE A FREE HOME CONSULTATION</span>
          <span className='sm:hidden text-lg font-bold mt-8'>FREE CONSULTATION</span>
        </a>
      </motion.div>
    </div>
  )
